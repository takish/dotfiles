...
description: "曲を設計視点で分析し、analysis/{slug}.mdに保存"
---

# Song Analyzer

引数: `$ARGUMENTS` = アーティスト名と曲名（例: `YOASOBI アイドル`）
...
4. **Arrangement** - ジャンル、楽器構成、密度設計、リズム/プロダクション設計
...
- YOASOBI 夜に駆ける → `yoasobi_yoru_ni_kakeru`
